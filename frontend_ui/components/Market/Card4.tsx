  ...
  return (
    <div className='w-[25rem] rounded-2xl p-8 bg-dark-secondary'>
      <div className='flex justify-between'>
        <div>
          <h5 className='text-xs mb-2 mr-1'>Total Lent</h5>
          <h4 className='text-2xl font-bold'>$2,500</h4>
        </div>
        <div className='flex flex-col items-end'>
          <h5 className='text-xs mb-2 mr-1'>Total Borrowed</h5>
          <h4 className='text-2xl font-bold'>$2,500</h4>
        </div>
      </div>
      <div className='flex justify-between mb-3 mt-6'>
        <div className='flex items-center'>
          <h5 className='text-xs mr-1'>Total Borrow Limit</h5>
          <InfoIcon text-white />
        </div>
      ...
      <h5 className='text-xs mt-3'>15%</h5>
    </div>
  );
};
